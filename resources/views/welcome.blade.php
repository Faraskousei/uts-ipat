                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formActionEdit" name="formActionEdit" class="form-horizontal">
                                ...
                                <button type="submit" class="btn btn-primary btn-block" id="btnEdit" value="edit">Save
                                </button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer bg-whitesmoke br">
                            ...
                            <button type="button" class="btn btn-danger" name="btnDelete" id="btnDelete">Delete
                                Data</button>
                        </div>
                    </div>
                </div>
            ...
            <script>
                ...
                $(document).ready(function() {
                    $('#formActionEdit').submit(function(e) {
                        ...
                        $.ajax({
                            url: 'http://localhost:8100/mahasiswa/15210012',
                            type: 'PUT',
                            data: JSON.stringify({
                                'npm': data_npm,
                                'name': $('#name-edit').val(),
